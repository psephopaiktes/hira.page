...
> 引用 あのイーハトーヴォのすきとおった風、夏でも底に冷たさをもつ青いそら、うつくしい森で飾られたモリーオ市、郊外のぎらぎらひかる草の波。
...
```html
<a class="download" href="/download/weba_chrome-stylize.zip" download="weba_chrome-stylize.zip">テンプレート</a>
```
