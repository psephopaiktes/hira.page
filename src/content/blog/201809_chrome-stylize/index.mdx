...
### テンプレート
<a href="/download/weba_chrome-stylize.zip" download>テンプレート 最小構成</a>
最小のファイル構成で作成した例です。ダウンロードして解凍後、好きなように改造してください。

<a href="/download/weba_chrome-stylize_npm.zip" download>テンプレート SCSS, BABEL有り</a>
