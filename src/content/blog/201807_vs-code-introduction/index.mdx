...
![デザイン例](./スクリーンショット 2018-07-12 14.34.14.png)
![デザイン例](./スクリーンショット 2018-07-12 14.35.34.png)
...
<EmbedCard
    ...
    title="Visual Studio Live Share: リアルタイム コード コラボレーション ツール"
