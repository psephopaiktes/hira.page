...
## 背景・前説
Android OS はもともと、iOSと違って多くのデバイスで使われることを想定しています。iOSが自社製作のデバイスであるiPhone・iPadでのみ使われるのに対して、AndroidはGoogle以外が作った多くのスマートフォンやタブレットにもインストールされ、様々な環境で使用されますね。
...
<EmbedCard
    ...
    title="Material Design 3 をざっくりまとめ | WEBA"
    site="hira.page" />


### そもそもフォルダブルデバイス（折りたたみスマホ）ってなんなん？
よく名前を聞くようになってきた<b>折りたたみスマホ</b>。柔軟性を持たせられる<b>有機ELディスプレイ</b>により、画面を曲げておりたたむことができるデバイスです（液晶ディスプレイ+物理ヒンジ構成のもあります）。
...
<EmbedCard
    ...
    title="12L の機能と変更点  |  Android 12  |  Android Developers"
...
<EmbedCard
    ...
    title="意外と簡単？Navigation rail導入のお話 - Speaker Deck"
...
<EmbedCard
    ...
    img="https://developer.android.com/images/social/android-developers.png"
    title="大画面の事例紹介  |  Android デベロッパー  |  Android Developers"
    site="developer.android.com" />
...
<blockquote class="twitter-tweet"><p lang="ja" dir="ltr">U-NEXTが昨日のアップデートで、Galaxy Z Fold などのFoldableスマホに対応しました。<br /><br />本のように見開きでマンガを読めます。意外とこれできるスマホアプリ無くて、たぶんU-NEXTが初 <a href="https://t.co/ADeYvSgKVs">pic.twitter.com/ADeYvSgKVs</a></p>&mdash; 平田 / U-NEXT (@psephopaiktes) <a href="https://twitter.com/psephopaiktes/status/1458268803549175809?ref_src=twsrc%5Etfw">November 10, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
